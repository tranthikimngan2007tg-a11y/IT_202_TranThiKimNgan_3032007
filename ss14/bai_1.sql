...
-- Sự cố này vi phạm tính Atomicity (Tính nguyên tử) trong nguyên lý ACID.
-- Vì một giao dịch phải được thực hiện toàn bộ hoặc không thực hiện gì cả, trường hợp này hệ thống chỉ hoàn thành bước trừ tiền ví nhưng chưa cập nhật công nợ, khiến dữ liệu bị không đồng nhất.